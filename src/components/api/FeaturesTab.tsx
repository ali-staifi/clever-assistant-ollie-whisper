...
const FeaturesTab = () => {
  return (
    <Card className="p-6">
      ...
      <div className="mb-6">
        <h3 className="text-lg font-medium mb-2">Recherche web avec Tavily</h3>
        <p className="mb-2">
      ...
      <div className="mb-6">
        <h3 className="text-lg font-medium mb-2">API Google</h3>
        <p className="mb-2">
      ...
      <div>
        ...
        <div className="mt-4">
          <h4 className="font-medium text-base">Objectifs du MCP:</h4>
        ...
        <div className="mt-4">
          <h4 className="font-medium text-base">Cas d'utilisation:</h4>
          <ul className="list-disc pl-6 space-y-1">
